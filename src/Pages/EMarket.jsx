...
const ProductCard = ({
  ...
  const handleNotifyMe = (e) => {
    ...
    const phoneNumber = "918762978777"; // ✅ your WhatsApp number
    ...
    >
      ...
      <div className="relative flex items-center justify-center bg-white p-4 h-48 sm:h-56 overflow-hidden rounded-lg">
        ...
        <img
          src={product.image}
          alt={product.name}
          className={`object-contain w-full h-full transition-transform duration-300 ${isOutOfStock ? "scale-105 blur-[1px]" : "scale-110 sm:scale-100"
            }`}
          onError={(e) => (e.target.src = PLACEHOLDER_IMAGE)}
        />

        {/* ❤️ WISHLIST BUTTON (ALWAYS VISIBLE) */}
        <button
      ...
      {/* Optional subtle text in center */}
      <button
        onClick={handleWishlistToggle}
        className="absolute top-3 right-3 z-30
             w-9 h-9 flex items-center justify-center
      ...
      <div className="lg:hidden bg-white border-b shadow-sm sticky top-0 z-30">
        <div className="px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-lg font-semibold text-gray-800">E-Store</h1>
